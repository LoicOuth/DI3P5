...
2. Perte ou destruction de données : Une défaillance matérielle, une erreur humaine ou une catastrophe naturelle pourrait entraîner la perte ou la destruction des données personnelles stockées sur uSite.
